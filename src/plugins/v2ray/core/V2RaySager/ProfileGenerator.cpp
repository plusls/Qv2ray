...
V2RaySagerProfileGenerator::V2RaySagerProfileGenerator(const ProfileContent &profile) : profile(profile){};

QByteArray V2RaySagerProfileGenerator::GenerateConfiguration(const ProfileContent &p)
{
    return V2RaySagerProfileGenerator(p).Generate();
}

QByteArray V2RaySagerProfileGenerator::Generate()
{
...
void V2RaySagerProfileGenerator::ProcessRoutingRule(const RuleObject &r)
{
    QJsonObject rule;
...
void V2RaySagerProfileGenerator::ProcessInboundConfig(const InboundObject &in)
{
    QJsonObject root;
...
void V2RaySagerProfileGenerator::ProcessOutboundConfig(const OutboundObject &out)
{
...
void V2RaySagerProfileGenerator::ProcessBalancerConfig(const OutboundObject &out)
{
...
QJsonObject V2RaySagerProfileGenerator::GenerateStreamSettings(const IOStreamSettings &stream)
{
    return stream;
}
